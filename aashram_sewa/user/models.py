...
class user_form(models.Model):
    ...
    spritual_name = models.CharField(max_length=200, blank=True)
    ...
    special_skill = models.CharField(max_length=200,blank=True)
    previous_volunteering_department = models.CharField(max_length=200,blank=True)
    hour_of_help = models.IntegerField(default=0)
    primary_manager=models.BooleanField(default=False)
    area_of_management = models.CharField(max_length=200,choices=RESPONSIBILITY_CHOICES, blank=True)
    ...
    seva_preference = models.CharField(max_length=200,choices=SEVA_CHOICES,blank=True)
    age=models.CharField(default=0, max_length=10, choices=AGE_CHOICES)
    sleep_dormitory=models.BooleanField(default=False)
    message = models.TextField(blank=True)
    privacy_policy = models.BooleanField(default=False)
    suscribe_to_newsletter = models.CharField(max_length=200,blank=True)
